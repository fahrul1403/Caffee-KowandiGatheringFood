...
<head>
    ...
    <title>KowandiFoodGathering | Disabled</title>
</head>
...
<body>
    <div class="container">
        ...
        <p class="paragraf2">dikarenakan anda telah melanggar peraturan yang berlaku di app kami</p>
        <img src="../img/disabled.svg">
        <p class="paragraf">Jika anda merasa tidak melanggar peraturan app kami</p>
