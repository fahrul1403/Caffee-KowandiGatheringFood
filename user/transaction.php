...
<head>
    ...
    <title>KowandiFoodGathering | Transaction</title>
</head>
    ...
    <section class="tabel">
        <div class="table-container">
            ...
            <section class="informasi">
                <h5>
                    <span class='transaksi'>Total Transaksi
                        <?= $totalTransaction; ?>
                    </span>
                </h5>
            </section>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td data-label="Opsi">
                            <a href="../checkout/payment.php?id=<?= $dataTransaction['id']; ?>" class="btn-lihat"><i
                                    class="fas fa-copy"></i>&nbsp;&nbsp;Lihat</a>
                        </td>
                    </tr>
                    <?php $i++; ?>
                    <?php endforeach; ?>
