    ...
    <header class="nav-top-mg">
        ...
        <nav class="nav-bot">
            <ul>
                ...
                <li class="dropdown1"><a href="#"><i class="fas fa-user"></i>&nbsp;&nbsp;User&nbsp;&nbsp;<i
                            class="fas fa-caret-down"></i></a>
                    <ul>
                        <li><a class="select" id="select2" href="user-admin.php"><i
                                    class="fas fa-users-cog"></i>&nbsp;&nbsp;Admin</a></li>
                        <li><a class="select" id="select2" href="user-customer.php"><i
                                    class="fas fa-user-friends"></i>&nbsp;&nbsp;Customer</a></li>
                        <li><a class="select" id="select2" href="transaction-logger.php"><i
                                    class="fas fa-money-check-alt"></i>&nbsp;&nbsp;Transaction</a></li>
                    </ul>
                </li>
            </ul>
        </nav>
    ...
    <section class="product">
        <div class="container">
            ...
            <div class="form">
                ...
                <div class="form-text">
                    <?= "Rp " . number_format($dataProduct['harga']); ?>
                </div>
            </div>
            <div class="form">
                <label class="form-label">Tanggal Ditambahkan</label><br>
                <div class="form-text">
                    <?= $dataProduct['tgl_tambah']; ?>
                </div>
            </div>
            <div class="form">
            ...
            <!-- Modal Box -->
            <a href="edit-product.php?id=<?= $dataProduct['id']; ?>" class="btn-biru"><i
