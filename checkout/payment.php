...
<head>
    ...
    <title>KowandiFoodGathering | Receipt</title>
</head>
                    ...
                    <?php foreach ($queryTransaction as $dataTransaction): ?>
                        <tr>
                            <td data-label="Nama Customer">
                                <?= $dataTransaction['nama_customer']; ?>
                            </td>
                            <td data-label="Menu">
                                <?= $dataTransaction['nama_product']; ?>
                            </td>
                            <td data-label="Quantity">
                                <?= $dataTransaction['quantity']; ?>
                            </td>
                            <td data-label="Total Harga">Rp
                                <?= number_format($dataTransaction['total_harga']); ?>
                            </td>
                            <td data-label="Tgl Transaksi">
                                <?= $dataTransaction['tgl_transaksi']; ?>
                            </td>
                            ...
                            <td data-label="Opsi" id="opsi">
                                <button onclick="window.print()" class="btn-print"><i
                                        class="fas fa-print"></i>&nbsp;&nbsp;Print</button>
                                <a href="../user/transaction.php" class="btn-back"><i
