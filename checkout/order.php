...
<head>
    ...
    <title>Kowandi Gathering Food | Order</title>
</head>
        ...
        <div class="container">
            ...
            <form method="post">
                ...
                <div class="form">
                    ...
                    <div class="form-text">Rp
                        <?= number_format($orderProduct['harga']); ?>
                    </div>
                </div>
                <div class="form">
                ...
                <div class="form">
                    ...
                    <input type="number" min="1" max="99" id="quantity" name="quantity" maxlength="2"
                        oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                        required>
                </div>
                <div class="form">
                    <h4 align="center">LAKUKAN PEMBAYARAN KE NOMOR <br>088290578237</h4>
                    <label class="form-label" for="payment_method">Metode Pembayaran <span id="bintang">*</span>
                    </label><br>
                    <div class="choose">
                        <input type="radio" class="btn-payment" name="payment_method" value="OVO" id="ovo"
                            required="required">
                        <label for="ovo" id="ovo-color" class="form__label">OVO</label>
                        <input type="radio" class="btn-payment" name="payment_method" value="Cash" id="gopay"
                            required="required">
                        <label for="gopay" id="gopay-color" class="form__label">Cash</label>
                        <input type="radio" class="btn-payment" name="payment_method" value="Dana" id="dana"
                            required="required">
                        <label for="dana" id="dana-color" class="form__label">Dana</label>
                    </div>
                </div>
                <button class="button-order" type="submit" name="order"><i
