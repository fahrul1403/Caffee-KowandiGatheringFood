...
function register($dataUser)
{
    ...
    // Input ke database
    mysqli_query($koneksi, "INSERT INTO tbl_user VALUES (null, '$nama_lengkap' , '$username', '$password', '$tgl_buat', '$status', '$role', '$job_desc', '$rating')");
...
function tambahProduk($dataProduk)
{
    ...
    $queryProduk = "INSERT INTO tbl_product VALUES (null, '$gambar', '$nama_product', '$harga', '$tgl_tambah', '$terjual', '$deskripsi')";
...
function orderMenu($dataOrder)
{
    ...
    $queryOrder = "INSERT INTO tbl_order VALUES (null, '$id_user', '$id_product', '$nama_product', '$harga_satuan', '$nama_customer', '$alamat', '$quantity', '$total_harga', '$payment_method', '$tgl_transaksi')";
